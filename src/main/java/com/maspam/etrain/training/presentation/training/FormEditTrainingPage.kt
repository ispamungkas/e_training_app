...
fun FormEditTrainingPage(
    ...
    LaunchedEffect(Unit) {
        trainingViewModel.setInitialValue(trainingModel)
    }
                        ...
                        Box(
                            ...
                            Text(
                                ...
                                text = if (filename?.isNotBlank() == true) {
                                    filename
                                } else if (trainingModel.image?.isNotBlank() == true) {
                                    trainingModel.image
                                }else {
            ...
            if (state.showConfirmationModal) {
                ModalBottomSheet(
                    ...
                    ConfirmationBottomSheetFlexComponent(
                        ...
                        trainingViewModel.showConfirmationModal(false)
                        trainingViewModel.onChangeAction(
                            action = FormTrainingEvent.Update(
