...
interface EnrollDataSource {
    ...
    suspend fun getDetailEnroll(token: String, enrollId: Int): Result<EnrollModel, NetworkError>
    suspend fun getEnrollByEnrollId(token: String, enrollId: Int): Result<EnrollModel, NetworkError>
    suspend fun updateAttendance(token: String, enrollId: Int): Result<EnrollModel, NetworkError>
    ...
    suspend fun checkCertificate(token: String, value: String): Result<String, NetworkError>
}